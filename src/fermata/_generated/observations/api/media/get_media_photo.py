...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/media/photo/{organization_id}/{photo_id}".format(organization_id=quote(str(organization_id), safe=""),photo_id=quote(str(photo_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """  Get photo media (redirects to S3 presigned URL)
