...
T = TypeVar("T", bound="ModelsUnhidePredictionsRequest")



@_attrs_define
class ModelsUnhidePredictionsRequest:
    """ Request to unhide predictions

        Attributes:
            prediction_ids (list[UUID]): List of prediction IDs to unhide
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        models_unhide_predictions_request = cls(
            prediction_ids=prediction_ids,
        )


        models_unhide_predictions_request.additional_properties = d
        return models_unhide_predictions_request
