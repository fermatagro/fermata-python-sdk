...
from ...models.models_set_preset_name_request import ModelsSetPresetNameRequest
...
def _get_kwargs(
    preset_id: UUID,
    *,
    body: ModelsSetPresetNameRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/presets/{preset_id}/name".format(preset_id=quote(str(preset_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """  Set the name of a threshold preset

    Args:
        preset_id (UUID): UUID identifier
        body (ModelsSetPresetNameRequest): Request to set a preset name
