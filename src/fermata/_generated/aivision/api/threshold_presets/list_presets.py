...
def _get_kwargs(
    *,
    level: ModelsPresetLevel | Unset = UNSET,
    model_name: str | Unset = UNSET,
    preset_type: ModelsPresetType | Unset = UNSET,
    ...
    json_preset_type: str | Unset = UNSET
    if not isinstance(preset_type, Unset):
        json_preset_type = preset_type.value

    params["presetType"] = json_preset_type
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        preset_type (ModelsPresetType | Unset): Preset category
        selected (bool | Unset):
        cursor (str | Unset):
