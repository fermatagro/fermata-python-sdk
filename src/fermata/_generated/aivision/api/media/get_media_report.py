...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/media/report/{organization_id}/{report_id}".format(organization_id=quote(str(organization_id), safe=""),report_id=quote(str(report_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """  Get report PDF (redirects to S3 presigned URL)
