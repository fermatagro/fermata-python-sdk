...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/reports/{report_id}/callback/success".format(report_id=quote(str(report_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """  Gotenberg webhook callback for successful PDF generation (redirects to S3 presigned URL)
