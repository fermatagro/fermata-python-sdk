...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/pipelines/fires/{fire_id}/cancel".format(fire_id=quote(str(fire_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ModelsCancelSkipRequest | Unset): Optional reason for cancel/skip operations
