...
from ...models.update_template_description_body import UpdateTemplateDescriptionBody
...
def _get_kwargs(
    template_id: UUID,
    *,
    body: UpdateTemplateDescriptionBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/pipelines/templates/{template_id}/description".format(template_id=quote(str(template_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """  Update a pipeline template description
