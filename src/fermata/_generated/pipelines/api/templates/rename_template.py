...
from ...models.rename_template_body import RenameTemplateBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/pipelines/templates/{template_id}/name".format(template_id=quote(str(template_id), safe=""),),
    }
