...
from ...models.update_schedule_cron_body import UpdateScheduleCronBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/pipelines/schedules/{schedule_id}/cron".format(schedule_id=quote(str(schedule_id), safe=""),),
    }
