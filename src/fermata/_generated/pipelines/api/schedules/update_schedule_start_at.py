...
from ...models.update_schedule_start_at_body import UpdateScheduleStartAtBody
...
def _get_kwargs(
    schedule_id: UUID,
    *,
    body: UpdateScheduleStartAtBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/pipelines/schedules/{schedule_id}/start-at".format(schedule_id=quote(str(schedule_id), safe=""),),
    }
