...
from ...models.update_schedule_arguments_body import UpdateScheduleArgumentsBody
...
def _get_kwargs(
    schedule_id: UUID,
    *,
    body: UpdateScheduleArgumentsBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/pipelines/schedules/{schedule_id}/arguments".format(schedule_id=quote(str(schedule_id), safe=""),),
    }
