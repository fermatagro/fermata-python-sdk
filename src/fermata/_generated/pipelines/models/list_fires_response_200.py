...
T = TypeVar("T", bound="ListFiresResponse200")


@_attrs_define
class ListFiresResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_fires_response_200 = cls(
            items=items,
            next_token=next_token,
        )

        list_fires_response_200.additional_properties = d
        return list_fires_response_200
