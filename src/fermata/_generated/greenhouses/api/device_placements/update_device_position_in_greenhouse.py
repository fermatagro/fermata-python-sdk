...
from ...models.update_device_position_in_greenhouse_body import UpdateDevicePositionInGreenhouseBody
...
def _get_kwargs(
    ...
    device_id: UUID,
    *,
    body: UpdateDevicePositionInGreenhouseBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/greenhouses/{greenhouse_id}/devices/{device_id}/position".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update device position in greenhouse
