...
from ...models.set_greenhouse_timezone_body import SetGreenhouseTimezoneBody
...
def _get_kwargs(
    greenhouse_id: UUID,
    *,
    body: SetGreenhouseTimezoneBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/greenhouses/{greenhouse_id}/timezone".format(
