...
from ...models.resize_greenhouse_body import ResizeGreenhouseBody
...
def _get_kwargs(
    greenhouse_id: UUID,
    *,
    body: ResizeGreenhouseBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/greenhouses/{greenhouse_id}/dimensions".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Resize greenhouse grid dimensions
