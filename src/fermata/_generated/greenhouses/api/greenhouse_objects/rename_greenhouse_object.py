...
from ...models.rename_greenhouse_object_body import RenameGreenhouseObjectBody
...
def _get_kwargs(
    ...
    object_id: str,
    *,
    body: RenameGreenhouseObjectBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/greenhouses/{greenhouse_id}/objects/{object_id}/name".format(
