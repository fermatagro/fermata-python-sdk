...
from ...models.relocate_greenhouse_object_body import RelocateGreenhouseObjectBody
...
def _get_kwargs(
    ...
    object_id: str,
    *,
    body: RelocateGreenhouseObjectBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/greenhouses/{greenhouse_id}/objects/{object_id}/position".format(
