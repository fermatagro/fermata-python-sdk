...
from ...models.set_zone_object_device_body import SetZoneObjectDeviceBody
...
def _get_kwargs(
    zone_object_id: UUID,
    *,
    body: SetZoneObjectDeviceBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/zone-objects/{zone_object_id}/device".format(
