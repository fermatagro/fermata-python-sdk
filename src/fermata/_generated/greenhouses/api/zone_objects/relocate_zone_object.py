...
from ...models.relocate_zone_object_body import RelocateZoneObjectBody
...
def _get_kwargs(
    zone_object_id: UUID,
    *,
    body: RelocateZoneObjectBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/zone-objects/{zone_object_id}/location".format(
