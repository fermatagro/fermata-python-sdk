...
T = TypeVar("T", bound="RelocateZoneObjectBody")


@_attrs_define
class RelocateZoneObjectBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        relocate_zone_object_body = cls(
            pos=pos,
            height=height,
        )

        relocate_zone_object_body.additional_properties = d
        return relocate_zone_object_body
