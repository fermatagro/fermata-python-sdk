...
T = TypeVar("T", bound="UpdateDevicePositionInGreenhouseBody")


@_attrs_define
class UpdateDevicePositionInGreenhouseBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_device_position_in_greenhouse_body = cls(
            pos=pos,
            height=height,
            orientation_vector=orientation_vector,
        )

        update_device_position_in_greenhouse_body.additional_properties = d
        return update_device_position_in_greenhouse_body
