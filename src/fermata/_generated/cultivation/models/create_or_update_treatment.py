...
T = TypeVar("T", bound="CreateOrUpdateTreatment")


@_attrs_define
class CreateOrUpdateTreatment:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_or_update_treatment = cls(
        ...
        create_or_update_treatment.additional_properties = d
        return create_or_update_treatment
