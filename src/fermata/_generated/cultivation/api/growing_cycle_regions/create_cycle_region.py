...
from ...models.create_or_update_growing_cycle_region import CreateOrUpdateGrowingCycleRegion
...
def _get_kwargs(
    ...
    region_id: UUID,
    *,
    body: CreateOrUpdateGrowingCycleRegion,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/cycles/{cycle_id}/regions/{region_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create a region in a growing cycle
