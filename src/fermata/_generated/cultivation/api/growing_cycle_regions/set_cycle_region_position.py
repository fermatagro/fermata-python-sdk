...
from ...models.set_cycle_region_position_body import SetCycleRegionPositionBody
...
def _get_kwargs(
    ...
    region_id: UUID,
    *,
    body: SetCycleRegionPositionBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/cycles/{cycle_id}/regions/{region_id}/position".format(
